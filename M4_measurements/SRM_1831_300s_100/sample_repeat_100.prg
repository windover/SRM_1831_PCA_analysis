...
var   ZFocus,X,Y,
      ...
      RealTime_FE,LifeTimeTest,LifeTimeExtra : LongInt;
      //
...
BEGIN
   ...
   Current_FE     := 200;    // in mA
   LiveTime_FE    := 300000;   // in ms
   //RealTime_FE    := 30000;   // in ms
   //LifeTimeTest   := 250000;
   //LifeTimeExtra  := 100000;
   //
   // Filter Al 0.012 mm
   //
   ...
   //
   DirectoryName := 'C:\M4 User\Xrf\Data\windover\SRM_1831_300s_100\';
   FileName:= DirectoryName + 'SRM_1831_300s_100_';
   //
   ////////
   ...
   //
   TargetDirectoryName := 'C:\M4 User\Xrf\Data\windover\SRM_1831_300s_100\';
   TargetFileName := TargetDirectoryName + 'target_locations_5.txt';
   ZOffsetFileName := TargetDirectoryName + 'Z_offset_100.txt'
         ...
         If RhTube = True Then
            ...
            If FE = True Then
               ...
               If Det1 = True Then
                  ...
                  UNTIL (LifeTime > (LiveTime_FE - 10000)) OR (MeasureState > 80.0);
                  writeln('1000ms counter det1: ' + IntToStr(Timer));
                  writeln('Measure State: ' + FloatToStr(MeasureState));
                  writeln('RealTime: ' + IntToStr(RealTime));
                  writeln('LifeTime: ' + IntToStr(LifeTime));
                  writeln('Dead Time ratio: ' + FloatToStr(Variable));
                  TimeLeft := round((LiveTime_FE - LifeTime) * Variable);
               ...
               If Det2 = True Then
                  ...
                  REPEAT
                     ...
                     //writeln('Dead Time ratio: ' + FloatToStr(Variable));
                  UNTIL (LifeTime > (LiveTime_FE - 10000)) OR (MeasureState > 80.0);
                  writeln('200ms counter det1: ' + IntToStr(Timer));
                  writeln('Measure State: ' + FloatToStr(MeasureState));
                  writeln('RealTime: ' + IntToStr(RealTime));
                  writeln('LifeTime: ' + IntToStr(LifeTime));
                  writeln('Dead Time ratio: ' + FloatToStr(Variable));
