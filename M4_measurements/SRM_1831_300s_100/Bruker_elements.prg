...
BEGIN
   ...
   //
   DirectoryName := 'C:\M4 User\Xrf\Data\windover\pulse_pileup_study\50kv_600mA\';
   FileName:= DirectoryName + 'Bruker_Elments_50kV_600_';
   //
   ////////
   ...
   //
   TargetDirectoryName := 'C:\M4 User\Xrf\Data\windover\pulse_pileup_study\50kv_600mA\';
