...
var   ZFocus,X,Y,
      ...
      RealTime,LifeTime,
      CameraIndex,BufSize,
      Timer,TimeLeft,Status,MoPoState        : LongInt;
      //
...
BEGIN
   ...
   //
   DirectoryName := 'C:\M4 User\Xrf\Data\windover\pulse_pileup_study\50kv_50mA_180s\';
   FileName:= DirectoryName + 'Bruker_Elments_50kV_600_300s_';
   //
   ////////
   ...
   //
   TargetDirectoryName := 'C:\M4 User\Xrf\Data\windover\pulse_pileup_study\50kv_50mA_180s\';
   TargetFileName := TargetDirectoryName + 'target_locations_Bruker_elements.txt';
   ZOffsetFileName := TargetDirectoryName + 'Z_offset.txt'
   ElementFileName := TargetDirectoryName + 'Bruker_elements.txt'
   //
   //////////
   //  Z in focus
