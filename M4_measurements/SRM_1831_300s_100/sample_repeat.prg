...
BEGIN
   ...
   //
   DirectoryName := 'C:\M4 User\Xrf\Data\windover\SRM_1831_300s_50\';
   FileName:= DirectoryName + 'SRM_1831_300s_50_';
   //
   ////////
   ...
   //
   TargetDirectoryName := 'C:\M4 User\Xrf\Data\windover\SRM_1831_300s_50\';
   TargetFileName := TargetDirectoryName + 'target_locations_sample.txt';
   ZOffsetFileName := TargetDirectoryName + 'Z_offset_50.txt'
